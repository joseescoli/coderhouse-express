...
router.get('/api', view.listAllApisView); // Listado de rutas disponibles
...
router.get('/realtimeproducts', isAuth, access('user', 'admin'), view.listAllProdsRealtimeView);    // Listado de productos actualizados en tiempo real mediante websocket. (Sólo usuarios autenticados).
