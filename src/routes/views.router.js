...
router.get('/api/users/premium/:uid', isAuth, access('admin'), view.changeRolePremium); // Cambio de rol de usuario por ID. El rol se cambia de 'user' a 'premium' o viceversa. (Sólo administradores).
